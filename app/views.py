...
def post_page(request, slug):
    ...
    context = {'post':post, 'form':form, 'comments':comments, 'is_bookmarked':is_bookmarked, 'recent_posts':recent_posts,'top_authors':top_authors,
               'tags':tags, 'related_posts':related_posts, 'post_is_liked':post_is_liked, 'number_of_likes':number_of_likes}
